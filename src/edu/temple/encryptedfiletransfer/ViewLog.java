...
public class ViewLog extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		txtUserMessage = (TextView) findViewById(R.id.txtVwViewLogWelcome);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.Logout:
			...
			Intent logoutIntent = new Intent(ViewLog.this, MainActivity.class);
			...
			return true;
		case R.id.Home:
			Intent homeIntent = new Intent(ViewLog.this, HomeActivity.class);
			...
			return true;
		case R.id.AddFriend:
			Intent addFriendIntent = new Intent(ViewLog.this, AddFriend.class);
			...
			return true;
		case R.id.SendFile:
			Intent fileIntent = new Intent(ViewLog.this, SendFile.class);
